...
using PaymentMethod = OnSale.Commom.Models.PaymentMethod;
...
namespace OnSale.Prism.ViewModels
{
    public class FinishOrderPageViewModel : ViewModelBase
    {
        ...
        private readonly string _testApiKey = "pk_test_51JMUpaBPN0jiLXfZQi2gusVAveMJQjLkThfHTkZHQyjGJZR21Jva9IPWNa4uxVS7fl4alrjFitIHgUHUUDZ7quWL00ihGNh1jv";
        private readonly string _testApiKeySecret = "sk_test_51JMUpaBPN0jiLXfZOQv9rYCim5tHp4pMyWWf4Iqp8F5hQPfZeLxgMfrjVpe2OzxOLKzhlEnqa2flExsIcAuWc9SC00Ep8yiX6M";
        ...
        private Commom.Enums.PaymentMethod ToPaymentMethod(PaymentMethod paymentMethod)
        {
            switch (paymentMethod.Id)
            {
                case 1: return Commom.Enums.PaymentMethod.Cash;
                default: return Commom.Enums.PaymentMethod.CreditCard;
            }
        }
