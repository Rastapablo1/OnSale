...
namespace OnSale.Web.Migrations
{
    ...
    [Migration("20210711201321_DeleteCascadeForCountries")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnSale.Commom.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnSale.Commom.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnSale.Commom.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnSale.Commom.Entities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnSale.Commom.Entities.City", b =>
                {
                    b.HasOne("OnSale.Commom.Entities.Department", "Department")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("OnSale.Commom.Entities.Department", b =>
                {
                    b.HasOne("OnSale.Commom.Entities.Country", "Country")
            ...
            modelBuilder.Entity("OnSale.Web.Data.Entities.User", b =>
                {
                    b.HasOne("OnSale.Commom.Entities.City", "City")
                        .WithMany()
